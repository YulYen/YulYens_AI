...
| 5   | Chatverläufe speichern/laden        | Sessions persistent (JSON/DB)   |   M    |   L   | Technische Basis |
...
| 14  | STT/TTS (Sprache ↔ Text) MVP        | Einfache Sprach‑I/O             |   M    |   M   | Cooles Feature   |
| 15  | Sandbox-/PDF‑Funktionen             | Lokale Doku‑Spielwiese          |   L    |   M   | Cooles Feature   |
| 16  | Tagesbrief (IoT + RSS)              | Tägliche Kurzupdates            |   M    |   M   | Cooles Feature   |
