...
PROMPTS_100_OLD = [
    ...
    "Schreib mir einen Glückwunsch.",
    "Gib mir einen Spitznamen.",
    "Hast du Langeweile?",
    "Klingst du gern klug?",
    "Beschreib mich in einem Wort.",
]

PROMPTS_100_2 = [
    "Sag was, das nach Kompliment klingt, aber keins ist.",
    "Tu so, als wärst du beeindruckt.",
    "Schreib einen Satz, den man auf ein Poster drucken könnte.",
    "Sag etwas, das wie Motivation klingt, aber keins ist.",
    "Mach mir ein Lob, das fast wie ein Diss klingt.",
    "Reagiere so, als wäre ich zu spät dran.",
    "Sag mir was Nettes, aber so, als würdest du es bereuen.",
    "Antworte nur mit einem genervten Lob.",
    "Stell dir vor, ich klopfe an deine Tür – was sagst du?",
    "Jemand sagt dir „Du bist süß“ – wie konterst du?",
    "Sag mir was, das klingt wie ein Horoskop.",
    "Wie würdest du mich im Chat abservieren?",
    "Mach mir Mut in fünf Wörtern.",
    "Sag mir, dass ich okay bin – aber trocken.",
    
    # Wissensfragen (leicht & abwatschbar)
    "Wie viele Tage hat der Februar?",
    "Wer war der erste Mensch im Weltall?",
    "Wie viele Sterne hat die EU-Flagge?",
    "Welche Stadt nennt man die „ewige Stadt“?",
    "Wer entdeckte Amerika im Jahr 1492?",
    ...
    "Welches Tier ist das Wappentier von Deutschland?",
    ...
    "Wie heißt das größte Land der Erde?",
    "Wer entdeckte die Gravitation (Apfel-Legende)?",
    "Wie viele Herzen hat ein Oktopus?",
    "Wer gilt als „Vater der Psychoanalyse“?",
    "Was ist die Hauptstadt von Portugal?",
    "Wie viele Planeten sieht man ohne Teleskop?",
    "Wer schrieb „1984“?",
    "Was ist die Hauptstadt von Griechenland?",
    "Wer erfand das Flugzeug (zugeschrieben)?",
